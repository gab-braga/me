      ...
      <div className="max-w-275 mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-start">
          ...
          <div className="relative pl-6">
            ...
            <div className="relative mb-9">
              ...
              <div className="text-[0.83rem] text-primary-light mb-2">
                IVI Data Science · Remoto
              </div>
              <p className="text-[0.83rem] text-[#6b7280] leading-[1.65]">
                Desenvolvimento e evolução de uma plataforma de cursos online e
                e-commerce, atuando na implementação de novas funcionalidades,
                melhorias de experiência do usuário e integração de sistemas de
                pagamento e gestão de conteúdo.
              </p>
            </div>
            ...
            <div className="relative mb-9">
              ...
              <div className="text-[0.83rem] text-primary-light mb-2">
                SoulCode Academy · Remoto
              </div>
              <p className="text-[0.83rem] text-[#6b7280] leading-[1.65]">
                Desenvolvimento de sites e sistemas para diferentes clientes,
                com atuação em JavaScript moderno, React e desenvolvimento
                frontend.
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <p className="text-[0.83rem] text-[#6b7280] leading-[1.65]">
                Atuação como professor e mentor em desenvolvimento de software,
                ministrando aulas de programação, orientando projetos e
                acompanhando a evolução dos alunos.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <div className="border border-[#1c2333] transition-[border-color,box-shadow] duration-250 hover:border-primary/50 hover:shadow-[0_0_0_1px_rgba(59,130,246,0.15),0_8px_32px_rgba(59,130,246,0.08)] rounded-[14px] p-5.5 bg-[#0f1420]">
              <div className="flex justify-between items-start mb-2">
                <h4 className="font-heading font-semibold text-[0.95rem]">
                  Ciência da Computação
                </h4>
                <span className="font-mono text-[0.7rem] text-[#6b7280]">
                  2020-2025
                </span>
              </div>
              <div className="text-[0.83rem] text-primary-light">
                Instituto Federal · Tianguá, CE
              </div>
            </div>
